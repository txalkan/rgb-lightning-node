...
use crate::routes::{
    ...
    refresh_transfers, restore, revoke_token, rgb_invoice, rgb_invoice_htlc, send_asset, send_btc,
    send_onion_message, send_payment, settle_hodl_invoice, shutdown, sign_message, sync, taker,
    unlock,
};
