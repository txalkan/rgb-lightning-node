...
use crate::routes::{
    ...
    hodl_invoice, htlc_claim, htlc_scan, init, invoice_status, issue_asset_cfa, issue_asset_nia,
    ...
    revoke_token, rgb_invoice, rgb_invoice_htlc, send_asset, send_btc, send_onion_message,
    send_payment, settle_hodl_invoice, shutdown, sign_message, sync, taker, unlock,
};
