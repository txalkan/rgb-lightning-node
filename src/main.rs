...
use crate::routes::{
    ...
    htlc_claim, htlc_scan, htlc_tracker, inflate, init, invoice_status, issue_asset_cfa,
    ...
    post_asset_media, refresh_transfers, restore, revoke_token, rgb_invoice, rgb_invoice_htlc,
